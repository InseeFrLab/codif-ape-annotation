# set env variables
export NAMESPACE='projet-ape'
export PATH_ANNOTATION_RESULTS='label-studio/annotation-campaign-2024/rev-NAF2025/eval-annotation/triple-annotation/data-annotated/in-progress'
export DATA_FILE_PATH_LOCAL='./data'
export PATH_ANNOTATION_PREPROCESSED='label-studio/annotation-campaign-2024/rev-NAF2025/eval-annotation/triple-annotation/preprocessed'
