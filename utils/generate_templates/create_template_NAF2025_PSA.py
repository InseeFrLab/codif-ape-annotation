...
text_element = etree.SubElement(
    ...
    "Text",
    name="domas",
    value="Domaine de l'association --> $domas",
    highlightColor="#00ff00",
)
text_element = etree.SubElement(
    first_view,
    "Text",
    name="ssdomas",
    value="Sous-domaine de l'association --> $ssdomas",
    highlightColor="#00ff00",
)
