...
NAF_mapping = correspondance_NAF.groupby('NAF2008').agg({'NAF2008_intitule': (lambda x: list(x.fillna('Indisponible pour le moment').unique())),
                                                    'NAF2025': (lambda x: list(x.fillna('Indisponible pour le moment').unique())),
                                                    'NAF2025_intitule': (lambda x: list(x.fillna('Indisponible pour le moment').unique())),
                                                    'comprend_niv5_belge': lambda x: list(x.fillna('Indisponible pour le moment').unique()),
                                                    'comprend_aussi_niv5_belge': lambda x: list(x.fillna('Indisponible pour le moment').unique()),
                                                    'ne_comprend_pas_niv5_belge': lambda x: list(x.fillna('Indisponible pour le moment').unique()),
                                                    'comprend_niv4_belge': lambda x: list(x.fillna('Indisponible pour le moment').unique()),
                                                    'comprend_aussi_niv4_belge': lambda x: list(x.fillna('Indisponible pour le moment').unique()),
                                                    'ne_comprend_pas_niv4_belge': lambda x: list(x.fillna('Indisponible pour le moment').unique())}).reset_index()
