...
# Import as dataframe
correspondance_NAF = pd.read_excel(excel_file_path, sheet_name='à compléter')
#print(correspondance_NAF.columns.values)
# Select columns
correspondance_NAF = correspondance_NAF[['NAFold-code à compléter',
                                        'NAFold-intitulé à compléter',
                                        'NAFnew-code à compléter', 
                                        'NAFnew-intitulé à compléter']]

# Drop the first row (index 0)
correspondance_NAF = correspondance_NAF.drop(0)

# Rename the column
correspondance_NAF.rename(columns={'NAFold-code à compléter': 'NAF2008', 
                                   'NAFold-intitulé à compléter': 'NAF2008_intitule', 
                                   'NAFnew-code à compléter': 'NAF2025', 
                                   'NAFnew-intitulé à compléter'}, inplace=True)
