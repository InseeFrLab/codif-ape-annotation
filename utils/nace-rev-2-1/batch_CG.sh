...
export SITE="CG"
export LABEL_STUDIO_SERVICE_ENDPOINT=$LABEL_STUDIO_SERVICE_ENDPOINT_REV_NAF2025_CG
export LABEL_STUDIO_TOKEN=$LABEL_STUDIO_TOKEN_REV_NAF2025_CG
...
python create_template_NAF2025_CG.py
